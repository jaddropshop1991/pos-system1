...
<div class="form-row">
 ...
 <div class="col-md-6">
    <input type="email" class="form-control" email="email" id="exampleInputFirstName" placeholder="Enter email" v-model="form.email">
...
<div class="col-md-6">
    <input type="text" class="form-control" name="shopname" id="exampleInputFirstName" placeholder="Enter shopname" v-model="form.shopname">
