...
<label for="exampleFormControlSelect1">Product Name</label>
    ...
    <input type="text" class="form-control" name="product_name" id="product_name" placeholder="Enter Your Product Name" v-model="form.product_name">
    <small class="text-danger" v-if="errors.product_name">{{ errors.product_name[0]}}</small>
    </div>
 <div class="col-md-6">
    <label for="exampleFormControlSelect1">Product Code</label>

    <input type="text" class="form-control" name="product-code" id="product_code" placeholder="Enter Your Product Code" v-model="form.product_code">
...
<div class="form-row">
    ...
    <div class="col-md-6">
                      ...
                      <!-- accessing the supplier_id in the drop down by using v-model to get the supplier_id fetched by axios on the created method  -->

                      <select class="form-control" name="supplier_id" id="supplier_id" v-model="form.supplier_id">
...
<label for="exampleFormControlSelect1">Product Root</label>
    ...
    <input type="text" class="form-control" name="root" id="root"  v-model="form.root">
...
<label for="exampleFormControlSelect1">Buying Price</label>
    ...
    <input type="text" class="form-control" name="buying_price" id="buying_price"  v-model="form.buying_price">
 ...
 <div class="col-md-4">
    ...
    <input type="text" class="form-control" name="selling_price" id="selling_price"  v-model="form.selling_price">
...
<div class="form-row">
    ...
    <input type="date" class="form-control" name="buying_date" id="buying_date"  v-model="form.buying_date">
    <small class="text-danger" v-if="errors.buying_date">{{ errors.buying_date[0]}}</small>
</div>
<div class="col-md-6">
                <label for="exampleFormControlSelect1">Product Quantity</label>

    <input type="text" class="form-control" name="product_quantity" id="product_quantity" placeholder="Enter Your Quantity" v-model="form.product_quantity">
...
export default {
    created(){
// on created get all categories data 
        axios.get('/api/allcategories')
        .then(({data}) =>(this.categories = data))
// on created get all suppliers data 
    ...
    formData.append("product_code", this.form.product_code);
     formData.append("category_id", this.form.category_id);
      formData.append("supplier_id", this.form.supplier_id);
            formData.append("root", this.form.root);
