...
<div class="col-6">
    <router-link to="/expense" class="btn btn-primary">All expenses </router-link>
     ...
     <label for="exampleFormControlTextarea1"><b>Enter Expense Details</b></label>                      
...
<div class="form-row">
    <div class="col-md-12">
         <label for="exampleFormControlTextarea1"><b>Enter Expense Amount</b></label>
...
//accessing the id returned by the index employee page by the edit button & that is given to the edit-employee route
   ...
   data(){
     ...
     methods: {
         ...
         expenseUpdate(){
             let id = this.$route.params.id
             axios.patch('/api/expense/update/'+id, this.form)
             .then(()=>{
