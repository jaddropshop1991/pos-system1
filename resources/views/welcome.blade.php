...
<head>
  ...
  <title>POS Inventory System Dashboard</title>
  ...
  <div id="wrapper">
    ...
    id="accordionSidebar">
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">POS Inventory System</div>
      </a>
...
{{------------- categories ---------}}
      ...
      <li class="nav-item">
        ...
        <div id="collapseBootstrap3" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            {{-- <h6 class="collapse-header">Bootstrap UI</h6> --}}
            <router-link to="/product" class="collapse-item" >All Prodcuts</router-link>

            <router-link to="/store-product" class="collapse-item" >Add Prodcuts</router-link>
...
<li class="nav-item">
  ...
  <div id="collapseBootstrap5" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
    <div class="bg-white py-2 collapse-inner rounded">
      {{-- <h6 class="collapse-header">Bootstrap UI</h6> --}}
      <router-link to="/given-salary" class="collapse-item" >Add Salaries</router-link>
...
{{------------ stock ---------- --}}
<li class="nav-item">
  <router-link to="/stock" class="nav-link" to="/stock">
  <i class="far fa-fw fa-window-maximize"></i>
    <span>Stock</span>
</router-link>
</li>
